    ...
    <div class="container mx-auto max-w-7xl">
      <div class="grid grid-cols-3 gap-4">
        ...
        <div>
          ...
          <h4 class="font-bold text-white">More</h4>
          <a href="#" class="fill-white my-4 text-white flex items-center">
            <span class="mr-2">
          ...
          <a href="#" class="fill-white mb-4 text-white flex items-center">
            <span class="mr-2">
              <svg height="24px" id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1"
                viewBox="0 0 512 512" width="24px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
